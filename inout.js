...
var questions = [
    ...
    function ask(i) {
        //stdout pour afficher dans la console difference entre stdout et console.log c'est que le consle.log utilise process.stdout.write avec un retour à la ligne 
